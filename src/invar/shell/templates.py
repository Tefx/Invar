...
`invar init` automatically generates `.invar/mcp-server.json` with the correct Python path.

### Claude Code

If `.claude/` exists, `invar init` updates `.claude/settings.json` automatically.
