...
from invar.core.rules_basic import check_contracts, check_doctests, check_forbidden_imports
...
def _has_file_escape(file_info: FileInfo, rule: str) -> bool:
    ...
    Examples:
        >>> marker = "# @invar:allow " + "file_size: reason"
        >>> info = FileInfo(path="test.py", lines=10, source=marker)
