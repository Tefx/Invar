...
# BUG F-12: SMTP_PASSWORD hardcoded
...
# BUG F-13: User input in email template not escaped - template injection
...
# BUG G-24: SMTP connection not closed on error
class EmailSender:
...
# BUG G-25: No retry on transient failure
...
# BUG D-09: @invar:allow[no-doctest] 'External service'
...
# BUG G-26: Failed notification not logged
...
# BUG B-17: send_email no doctests (defined above)


# BUG G-37: Unsubscribed users still receive notifications
