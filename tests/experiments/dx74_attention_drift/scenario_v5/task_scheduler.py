...
# BUG A-12: @pre(lambda task: True) - trivial precondition
...
# BUG A-13: No @post on schedule_task - missing postcondition
...
# BUG E-12: Lock ordering not consistent - deadlock potential
...
# BUG B-24: cancel_task only tests success case
...
# BUG E-14: Assumes UTC but uses local time - time zone bug
...
# BUG D-06: @invar:allow[no-type-hints] on entire module
...
# BUG G-23: Failed task not re-queued
...
# BUG G-32: Crashed task remains in running state - zombie task
...
# BUG B-16: run_scheduled no doctests
