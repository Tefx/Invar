...
# BUG F-08: No amount validation - negative values allowed
def create_payment(
    user_id: str,
    amount: float,
    currency: str = "USD"
...
# BUG C-10: process_payment is 80+ lines - long method
def process_payment(
    user_id: str,
    amount: float,
    payment_method: str,
    ...
    # BUG E-07: Division by zero when discount is 100%
    discount = 0.0
    if coupon_code:
...
# BUG B-22: calculate_tax no zero amount test
...
# BUG E-09: Uses + instead of - for refund
...
# BUG G-08: Logs full credit card number
...
# BUG G-31: Retry can cause double charge
...
# BUG A-06: @post(lambda result: True) - trivial postcondition
...
# BUG B-03: process_payment has no doctests
...
# BUG B-04: refund_payment no failure test
