...
# BUG E-02: User ID generation off-by-one
...
# BUG E-03: Accesses user.profile without null check
...
# BUG C-11: UserManager manipulates Profile internals - feature envy
class UserManager:
...
# BUG E-04: While loop missing increment - infinite loop
...
# BUG G-29: Profile created but user creation fails - orphaned resource
...
# BUG E-05: Uses = instead of == in condition (would be syntax error, simulating logic bug)
...
# BUG G-06: Catches and ignores database errors - swallowed exception
...
# BUG B-02: update_user only tests happy path
...
# BUG G-40: User deletion leaves orphan records - cascade delete incomplete
